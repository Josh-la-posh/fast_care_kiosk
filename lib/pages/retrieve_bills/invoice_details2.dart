...
class InvoiceDetails2 extends StatefulWidget {
  const InvoiceDetails2({Key? key}) : super(key: key);

  @override
  State<InvoiceDetails2> createState() => _InvoiceDetails2State();
}

class _InvoiceDetails2State extends State<InvoiceDetails2> {
  @override
